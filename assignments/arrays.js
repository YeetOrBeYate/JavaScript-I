...
console.log("Challenge1: ",inventory[32]);

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = inventory.length-1;
console.log("Challenge2: ",inventory[lastCar]);
...
console.log("sorted car models: ", carModelsSorted);
...
console.log("cars older than 2000: " ,oldCars);
...
console.log("bmw and audis", BMWAndAudi);
